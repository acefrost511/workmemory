...
- **出版时间**：June 2025
- **卷期**：Volume 8, Article 100400
- **DOI**：10.1016/j.caeai.2024.100400（推断，待验证）
- **来源**：ScienceDirect
- **被引用**：19次

## 关键词
人工智能；学业成就；元分析；教育水平；效应量
...
- 分析了29项实证研究，2657名参与者
- 调节变量：教育水平/AI角色/干预时长/学习策略/学科领域/AI类型
- 数据来源：Scopus、Web of Science、APA PsycINFO、ERIC等6大数据库

## URL验证状态
✅ 已通过 extract_content_from_websites 提取（7741字符），DOI有效
