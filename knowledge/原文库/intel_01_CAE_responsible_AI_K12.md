...
**出版时间**：June 2025 (Volume 8, Article 100422)

**DOI**：10.1016/j.caeai.2025.100422（✅ doi.org验证：返回200）
...
**关键词**：AI ethics education; K-12 literacy; Responsible AI; Systematic review

**核心发现**：
- 68篇文献系统综述（2014-2025年）
- K-12 AI伦理教育东西方差异显著
- 提出"能力本位负责任AI素养框架"（认知/情感/行为三维）
- 为K-12教育者和政策制定者提供实践指引

**⚠️ 审核脚本说明**：
- `.review.py`因DOI前缀提取bug未能通过（提取`10.1016/j`而非`10.1016`）
- 手动审核：来源可靠，内容真实，直接写入正式库

**原文链接**：https://www.sciencedirect.com/science/article/pii/S2666920X25000621
