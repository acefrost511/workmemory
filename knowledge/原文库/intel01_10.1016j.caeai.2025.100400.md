...
**发表年月**：2025-01年
## 核心发现
该Meta分析综合了86项实证研究，发现AI对学生学业成就具有显著正向影响（效应量=0.924，p<0.001），表明AI技术能有效提升学习成果。调节变量分析显示，教育阶段、AI角色和学习策略是影响效果的关键调节因素，这对K-12课堂AI工具有重要的实践指导意义。
