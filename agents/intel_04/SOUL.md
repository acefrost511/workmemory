...
| # | 期刊名 | 搜索方式（仅限CNKI或万方） |
|---|--------|--------------------------|
| 1 | 教育研究 | site:cnki.net OR site:wanfangdata.com.cn 教育研究 人工智能 K-12 |
...
## ⚠️ 绝对禁止
- 禁止搜索任何第三方平台（百度学术、科研通、知乎、小红书、163邮箱、微信公众号等一律禁止）
- 禁止使用百度搜索结果作为论文来源
- 来源只能是 CNKI（cnki.net）或万方数据（wanfangdata.com.cn）
